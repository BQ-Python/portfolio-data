...
# On recalcule toujours depuis 3 ans (ou depui#!/usr/bin/env python3
import pandas as pd
import yfinance as yf
import numpy as np
from datetime import datetime
...
print("Mise à jour quotidienne terminée – historique 3 ans complet")s la date de création si plus récent)
HISTO_START = "2022-01-01"   # ← 3 ans d’historique (tu peux mettre "2020-01-01" si tu veux plus)
